...
const ProductDetail = () => {
  ...
  const { title: params } = useParams(); //dinamik routelardaki değeri taşır
  ...
  const { category, title, thumbnail, price, description, images } = state;
      ...
      <div className="mt-6 w-full ">
        <article className="mx-auto w-full block lg:flex mt-4 h-full 2xl:h-[70vh]  shadow-lg border rounded-md duration-300 hover:shadow-sm">
          <div className="grid grid-rows-4 gap-2 h-full w-full lg:w-7/12 p-4">
            ...
            <div className="grid grid-cols-3 flex-row-2 gap-4 row-span-1 ">
